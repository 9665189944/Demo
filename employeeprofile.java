...
class employeeprofile extends JFrame implements ActionListener
{
   ...
   public employeeprofile()
 {
  ...
  pane.setLayout(null);
   ...
   label9=new JLabel("Employee Profile");
...
/*  img1=new JLabel("");
  ...
  img1.setBounds(500,-250,800,800);
   ...
   label=new JLabel("Our agency is a business corporation, which provides armed and unarmed security services and expertise to");
    ...
    pane.add(label);
*/
label1=new JLabel("Name - Salman Khan");
     label1.setFont(new Font("Times new roman",Font.BOLD,20));
    label1.setForeground(Color. black);
    label1.setBounds(360,370,500,50);
    pane.add(label1);

label2=new JLabel("Address - Baramati");
