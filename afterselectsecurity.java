...
class afterselectsecurity extends JFrame implements ActionListener
{
   ...
   public afterselectsecurity()
 {
  ...
  img.setBounds(0,-200,1050,1050);
     ...
     label1=new JLabel("Security Type : Household Security");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/security","root","");
 ...
 String sql="insert into selectsecurity  values('"+custname+"','"+custaddr+"','"+custno+"','"+custemail+"','"+custdob+"')";
