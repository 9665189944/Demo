...
class afterselectsecurity4 extends JFrame implements ActionListener
{
   ...
   public afterselectsecurity4()
 {
  ...
  img.setBounds(0,-200,1050,1050);
     ...
     label1=new JLabel("Security Type : School/College");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/security","root","");
 ...
 String sql="insert into selectsecurity4  values('"+custname+"','"+custaddr+"','"+custno+"','"+custemail+"','"+custdob+"')";
