...
class CustRegistration extends JFrame implements ActionListener
{
 JLabel img,l1,l2,l3,l4,l5,l6,label;
   ...
   public CustRegistration()
 {
  ...
  img.setBounds(0,-200,1040,1040);
   ...
   label=new JLabel("Customer Registration");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/security","root","");
 ...
 String sql="insert into cregistration  values('"+cname+"','"+caddr+"','"+cno+"','"+email+"','"+dob+"')";
