...
class EmpRegistration extends JFrame implements ActionListener
{
   ...
   public EmpRegistration()
 {
  ...
  img.setBounds(0,-200,1040,1040);
   ...
   label=new JLabel("Employee Registration");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/security","root","");
 ...
 String sql="insert into eregistration values('"+ename+"','"+eaddr+"','"+cno+"','"+email+"','"+dob+"')";
