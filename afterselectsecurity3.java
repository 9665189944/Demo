...
class afterselectsecurity3 extends JFrame implements ActionListener
{
   ...
   public afterselectsecurity3()
 {
  ...
  img.setBounds(0,-200,1050,1050);
     ...
     label1=new JLabel("Security Type : Personal Security");
   ...
   t5.setBounds(480,370,100,30);    
     ...
     label2=new JLabel("Cost       :          15,00,000");
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost/security","root","");
 ...
 String sql="insert into selectsecurity3  values('"+custname+"','"+custaddr+"','"+custno+"','"+custemail+"','"+custdob+"')";
